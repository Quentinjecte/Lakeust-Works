...
@section('entry', 'resources/js/project.js')

@php
    $img = fn ($name) => asset('images/jurassic-containment/' . $name);

    $missionAttrs = ['Spécimens', 'Objectifs', 'Niveaux de danger', 'Récompenses', 'Conditions d\'opération'];

    $devAxes = [
        ['n' => '01', 'titre' => 'Gameplay', 'texte' => 'Développer les mécaniques de chasse, de capture et de coopération.'],
        ['n' => '02', 'titre' => 'World', 'texte' => "Construire différents environnements et zones d'opération."],
        ['n' => '03', 'titre' => 'Creatures', 'texte' => 'Développer des spécimens avec des comportements et des situations de chasse variés.'],
        ['n' => '04', 'titre' => 'Systems', 'texte' => "Construire les systèmes de progression, d'équipement, de missions et de coopération."],
    ];
...
@section('content')
    ...
    <section style="position:relative;height:92vh;min-height:600px;overflow:hidden;">
        ...
        <div class="wrap" style="position:relative;height:100%;display:flex;flex-direction:column;justify-content:flex-end;padding-bottom:var(--s-8);">
            <div data-reveal="mask">
                <span class="mask-line"><span class="label" style="display:block;margin-bottom:var(--s-3);">En développement — PC</span></span>
            ...
            <p class="t-lead" data-reveal="blur" data-reveal-delay="180" style="margin-top:var(--s-4);max-width:46ch;">
                Hunt. Contain. Survive. Un jeu de chasse coopératif en première personne, où chaque mission
                vous confronte à des créatures préhistoriques imprévisibles.
            </p>
            <div style="display:flex;flex-wrap:wrap;gap:var(--s-4);align-items:center;margin-top:var(--s-6);" data-reveal="stagger" data-reveal-delay="320">
                <a class="btn" href="#projet"><span aria-hidden="true">▷</span> Découvrir le projet <span class="arrow" aria-hidden="true">→</span></a>
                <a class="btn btn-ghost" href="#galerie">Voir le showcase</a>
        ...
        <div class="wrap split">
            <aside class="split-aside">
                <div style="display:flex;flex-direction:column;gap:var(--s-4);" data-reveal="stagger">
                    <div>
                        <span class="label" style="display:block;margin-bottom:4px;">Rôle</span>
                        <span class="t-body" style="font-size:14px;">Conception &amp; développement</span>
                    </div>
                    <div>
                    ...
                    <div>
                        <span class="label" style="display:block;margin-bottom:4px;">Statut</span>
                        <span class="t-body" style="font-size:14px;">En développement</span>
                    </div>
                    <span class="mark"></span>
                    <a class="btn btn-ghost" href="#galerie" style="align-self:flex-start;">Voir les captures <span class="arrow" aria-hidden="true">→</span></a>
                </div>
            </aside>
            <div class="split-flow">
                <div>
                    <span class="label" data-reveal="rise">The hunt has begun</span>
                    <h2 class="t-h2" data-reveal="rise" style="margin-top:var(--s-2);">Traquer. Observer. Préparer. Contenir.</h2>
                    <p class="t-body" data-reveal="blur" style="margin-top:var(--s-3);">
                ...
                <div class="grid-3" data-reveal="stagger">
                    <div class="stat" data-count="4">
                        ...
                        <span class="stat-label">États environnement</span>
                    </div>
                    <div class="stat" data-count="4">
                        <span class="stat-value num" data-count-value>0</span>
                        <span class="stat-label">Contractants co-op</span>
                    </div>
                    <div class="stat" data-count="5">
                        <span class="stat-value num" data-count-value>0</span>
                        <span class="stat-label">Attributs par mission</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrap">
            ...
            <div style="display:grid;grid-template-columns:1fr minmax(240px,42%) 1fr;gap:clamp(16px,3vw,40px);align-items:center;">
                <div class="sc-in-left" data-scrub="0.05 0.7" data-scrub-ease="out" style="--amp:-84px;display:flex;flex-direction:column;gap:var(--s-3);align-items:flex-end;text-align:right;">
                    <span class="label">Relais coupé</span>
                    <span class="mark" data-reveal="line" style="width:100%;"></span>
                    <span class="t-body" style="font-size:13px;">Un relais détruit peut couper vos communications.</span>
                </div>
                ...
                <div style="position:relative;aspect-ratio:1/1;">
                    ...
                    <span class="label label-accent" data-reveal="rise" data-reveal-delay="620" style="position:absolute;left:50%;bottom:-26px;transform:translateX(-50%);white-space:nowrap;">Zone compromise</span>
                </div>
                ...
                <div class="sc-in-right" data-scrub="0.05 0.7" data-scrub-ease="out" style="--amp:84px;display:flex;flex-direction:column;gap:var(--s-3);">
                    <span class="label">Extraction dangereuse</span>
                    <span class="mark" data-reveal="line" style="width:100%;"></span>
                    <span class="t-body" style="font-size:13px;">Un spécimen agressif peut transformer une opération contrôlée en véritable situation de survie.</span>
                </div>
            </div>
    ...
    <section class="section-tight">
        <div class="wrap">
            <div style="max-width:60ch;">
                <span class="label" data-reveal="rise">Environnement</span>
    ...
    <section class="section" style="position:relative;overflow:hidden;">
        ...
        <div class="wrap" style="position:relative;max-width:64ch;text-align:center;margin-inline:auto;">
            ...
            <p class="t-lead" data-reveal="blur" data-reveal-delay="160" style="margin-top:var(--s-5);">
                La forêt est silencieuse. Trop silencieuse.
            </p>
            <p class="t-body" data-reveal="blur" data-reveal-delay="240" style="margin-top:var(--s-3);">
    ...
    <section class="section">
        <div class="wrap" style="display:grid;grid-template-columns:1fr 1fr;gap:clamp(24px,5vw,80px);align-items:center;">
            <div>
                <span class="label" data-reveal="rise">Préparation</span>
                ...
                <p class="t-body" data-reveal="blur" data-reveal-delay="80" style="margin-top:var(--s-3);">
    ...
    <section class="section" id="arsenal">
        <div class="wrap">
            ...
            @foreach ($arsenal as $category => $items)
                <div style="margin-top:var(--s-7);">
                    <span class="label label-accent" data-reveal="rise" style="display:block;margin-bottom:var(--s-4);">{{ $category }}</span>
                    <div class="grid-3" data-reveal="stagger">
    ...
    <section class="section">
        <div class="wrap" style="display:grid;grid-template-columns:1fr 1fr;gap:clamp(24px,5vw,80px);align-items:center;">
            ...
            <div style="order:1;">
                ...
                <span class="t-body" style="display:block;margin-top:var(--s-4);font-size:13px;color:var(--text-3);">Chaque mission présente ses propres :</span>
    ...
    <section class="section-tight" style="text-align:center;">
        <div class="wrap" style="max-width:56ch;margin-inline:auto;">
            ...
            <p class="t-body" data-reveal="blur" data-reveal-delay="120" style="margin-top:var(--s-5);">
        ...
        <div data-braid style="position:relative;height:100vh;overflow:hidden;display:grid;place-items:center;margin-top:var(--s-7);background:radial-gradient(70% 60% at 50% 45%,var(--bg-1),var(--bg) 76%);">
            <div style="position:relative;width:min(1080px,88vw);height:min(66vh,560px);">
                <article data-strand style="position:absolute;left:50%;top:50%;translate:-50% -50%;width:clamp(190px,21vw,290px);display:flex;flex-direction:column;gap:var(--s-3);will-change:transform,filter;text-align:left;">
                    ...
                    <span class="label">Stégosaure</span>
                ...
                <article data-strand style="position:absolute;left:50%;top:50%;translate:-50% -50%;width:clamp(190px,21vw,290px);display:flex;flex-direction:column;gap:var(--s-3);will-change:transform,filter;text-align:left;">
                    ...
                    <span class="label">Pachycéphalosaure</span>
            ...
            <div style="position:absolute;left:var(--gutter);bottom:var(--s-6);display:flex;gap:var(--s-4);align-items:baseline;pointer-events:none;">
                <span class="label">Au premier plan</span>
    ...
    <section class="section" style="text-align:center;">
        <div class="wrap" style="max-width:56ch;margin-inline:auto;">
            ...
            <p class="t-body" data-reveal="blur" data-reveal-delay="200" style="margin-top:var(--s-3);">
        ...
        <div class="wrap">
            <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:var(--s-4);margin-bottom:var(--s-5);">
                <div data-reveal="mask">
                    ...
                    <span class="mask-line"><h2 class="t-h2">Galerie</h2></span>
                </div>
                <span class="label" data-reveal="rise">Glisser · flèches · ← →</span>
            </div>
    ...
    <section class="section-tight">
        <div class="wrap">
            ...
            <p class="t-body" data-reveal="blur" style="margin-top:var(--s-3);max-width:56ch;">
            ...
            <div class="grid-2" style="margin-top:var(--s-6);" data-reveal="stagger">
                @foreach ($devAxes as $axe)
                    <div class="card">
                        ...
                        <span class="card-body">{{ $axe['texte'] }}</span>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="section">
        <div class="wrap" style="display:flex;flex-direction:column;align-items:flex-start;gap:var(--s-5);">
            ...
            <div data-reveal="mask">
                <span class="mask-line"><span class="label" style="display:block;margin-bottom:var(--s-3);">Le monde n'est pas prêt. Votre équipe non plus.</span></span>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:var(--s-3);" data-reveal="stagger">
                <a class="btn" href="{{ route('works') }}">Tous les travaux <span class="arrow" aria-hidden="true">→</span></a>
                <a class="btn btn-ghost" href="{{ route('about') }}#contact">Contact</a>
            </div>
        </div>
    </section>
@endsection
