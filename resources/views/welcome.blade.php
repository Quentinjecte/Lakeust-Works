...
<head>
    ...
    <title>{{ config('app.name', 'Lakeust Works') }}</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;500&display=swap" rel="stylesheet">

    @vite(['resources/js/welcome-blackhole.js'])
    ...
    <style>
        ...
        button:focus-visible, [data-bh="again"]:focus-visible { outline: 2px solid #9184d9; outline-offset: 2px; }
        @keyframes bh-drift { 0% { transform: translateY(0); opacity: .25 } 45% { opacity: .85 } 100% { transform: translateY(18px); opacity: 0 } }
        @keyframes bh-breathe { 0%, 100% { opacity: .34 } 50% { opacity: .68 } }
    </style>
</head>
<body>
@php
    ...
    $pages = [
        ...
        ['name' => 'BlackHole Cinematic',       'url' => '/welcome-cinematic'],
    ];
@endphp
