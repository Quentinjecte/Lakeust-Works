/* scroll-lab.js — entrée Vite de /scroll-lab (renommé depuis l'ancien
   resources/js/lab.js : ce fichier est le moteur de Scroll Lab, pas un
   fichier générique — la page catalogue /lab a son propre entry minimal,
   voir labs/catalogue/lab-catalogue.js). Page autonome (pas de layout
   partagé, pas de core/page-systems.js : seul animation/motion.js est
   nécessaire ici).
